...
export class CodeMirrorEditor implements CodeEditor.IEditor {
  ...
  // _focusMsg: (focused:boolean) => void | PromiseLike<void>;
  //
  // set focusMsg(cb: (focused:boolean) => void | PromiseLike<void>){
  //   this._focusMsg = cb;
  // }
  // get focusMsg(): (focused:boolean) => void | PromiseLike<void>{
